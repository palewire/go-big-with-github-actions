...
![Creating a new repo](_static/getting-started-1a.png)

Click on the "Create repository" button at the bottom of the form.

![Hitting create repo](_static/getting-started-1b.png)
...
![editor](_static/first-action-12.png)
...
![first-commit](_static/first-action-13.png)
...
![first-workflow](_static/first-action-14.png)
